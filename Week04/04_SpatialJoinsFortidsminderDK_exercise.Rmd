...
plot(______________, col = "red", add = T) 
...
In the previous chunk, you loaded all monuments across Denmark. In this exercise you need to make a plan for family visit. Your family like to bike in green areas and visit Viking monuments, so calculate:
