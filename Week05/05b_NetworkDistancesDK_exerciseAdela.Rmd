...
my_token <- "pk.eyJ1IjoiYWRpdmVhIiwiYSI6ImNrcWdhNGlybjB4OG0ydnNjcWZtOG9mc3UifQ.EbNmMF9aF8th5cb-h5f1lQ"
...
```{r geocode}
nobel <- mb_geocode("Jens Chr. Skous Vej 5, Aarhus N, Denmark ")
nobel
...
```{r geocode-openc}
library(opencage)
b <- oc_forward_df(placename = "Regionshospitalet Grenaa in Grenaa", countrycode = "DK", limit = 3)
leaflet() %>% 
  addTiles() %>% 
...
# Driving range
driving_isos <- mb_isochrone( h_sf,
  profile = "driving",
  time = 20,
  id = "placename"
)
